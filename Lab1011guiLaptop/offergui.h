...
private:
	...
	QTableWidget* offer_list = new QTableWidget();
	QListWidget* wishlist = new QListWidget();
	//QTableWidget* wishlist = new QTableWidget();
	...
	void populateGUI();
	void checkKievGUI();
	int howManyDests(const std::vector<Offer>& offers, const string& dest);
	...
	void updateList(QTableWidget* tbl);
